	...
	useEffect(() => {
		...
		function getPlayerId(playerId: string): string {
			if (playerId.toString().startsWith(":")) {
				...
				//const playerName = splitPlayerId[0];
				const playerHash = splitPlayerId[1];
				const playerVersion = splitPlayerId[2];

				const dictPlayerHashToPlayerName: any = {
					"a4d74640e1c395c46416581082d7154b": "AndrewShieldsPhone",
